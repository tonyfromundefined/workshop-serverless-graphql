...
- 프로젝트 폴더로 내에 `.env.development` 파일과 `.env.production` 파일을 수정해줍니다.
  - 전에 배포한 Prisma의 엔드포인트를 넣어주세요.
    ...
    - 예시: `http://prisma.ap-northeast-1.elb.amazonaws.com/serverless/dev`
  ...
  PRISMA_ENDPOINT="http://prisma.ap-northeast-1.elb.amazonaws.com/serverless/dev"
  ...
  PRISMA_ENDPOINT="http://prisma.ap-northeast-1.elb.amazonaws.com/serverless/prod"
  PRISMA_MANAGEMENT_API_SECRET="serverless"
  ```
